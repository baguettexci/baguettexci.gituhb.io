...
Trying out a couple of other ensemble method following this article, [CatBoost vs Light GBM vs XGBoost](https://towardsdatascience.com/catboost-vs-light-gbm-vs-xgboost-5f93620723db).
### CatBoost
```python
