...
<br/>
$${\text Haversine}= 2{\mathit r}{\text arcsin}\left(\sqrt {sin^2(\frac{\phi_2 - \phi_1}{2}) + cos(\phi_1)cos(\phi_2)sin^2(\frac{\lambda_2 - \lambda_1}{2})}\right)$$

$${\mathrm Haversine}= 2{\mathit r}{\mathrm arcsin}\left(\sqrt {{\mathrm sin^2}(\frac{\phi_2 - \phi_1}{2}) + {\mathrm cos}(\phi_1){\mathrm cos}(\phi_2){\mathrm sin^2}(\frac{\lambda_2 - \lambda_1}{2})}\right)$$
<br/>
