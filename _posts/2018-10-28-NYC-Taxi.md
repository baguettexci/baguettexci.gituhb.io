...
* $$\phi_1$$, $$\phi_2$$ 
* φ1, φ2 is the latitude of point 1 and latitude of point 2,
* λ1, λ2 is the longitude of point 1 and longitude of point 2.
<br/>
...
Using a linear regression model as a baseline model to gauge the performance.
```python
